...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Linkedin size={18} />, href: "https://www.linkedin.com/in/gokulanbalagan1112/", label: "LinkedIn" },
    { icon: <Instagram size={18} />, href: "#", label: "Instagram" },
    { icon: <Youtube size={18} />, href: "#", label: "YouTube" },
    { icon: <Github size={18} />, href: "https://github.com/Gokul1111-cmd", label: "GitHub" },
  ];
  ...
  const contactInfo = [
    { icon: <Mail size={16} />, text: "gokulanbalagan1112@gmail.com", href: "mailto:gokulanbalagan1112@gmail.com" },
    { icon: <Phone size={16} />, text: "+91 8754740118", href: "tel:+918754740118" },
  ];
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">GOKUL A</h3>
          ...
          >
            <div>
              <p>© {currentYear} Gokul A. All rights reserved.</p>
            </div>
