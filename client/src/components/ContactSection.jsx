  ...
  useEffect(() => {
    const fetchContact = async () => {
      ...
      try {
        ...
        if (resolved) setContactData((prev) => ({ ...prev, ...resolved }));
      } catch (err) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Please try again or email me directly at gokulanbalagan1112@gmail.com",
        variant: "destructive",
      });
    } finally {
          ...
          <div className="p-6 sm:p-8 rounded-xl sm:rounded-2xl bg-card border border-border shadow-sm">
            ...
            <form className="space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
              ...
              <button
                ...
                className={cn(
                  "w-full flex items-center justify-center gap-2 py-3 sm:py-4 px-6 sm:px-8 rounded-lg sm:rounded-xl bg-gradient-to-r from-primary to-purple-600 text-white font-medium hover:opacity-90 transition-all duration-300 shadow-lg shadow-primary/20 text-sm sm:text-base",
