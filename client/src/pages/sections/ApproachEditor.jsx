...
export const ApproachEditor = () => {
  ...
  const updateStepField = (idx, key, value) => {
    const next = Array.isArray(approachData.steps)
      ? [...approachData.steps]
      : [];
  ...
  const updateTimelineField = (idx, key, value) => {
    const next = Array.isArray(approachData.careerTimeline)
      ? [...approachData.careerTimeline]
      : [];
    next[idx] = { ...(next[idx] || {}), [key]: value };
        ...
        <form onSubmit={handleSave} className="space-y-6">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setApproachData({ ...approachData, title: e.target.value })
              }
            />
          </div>
          <div>
              ...
              {(approachData.steps || []).map((step, idx) => (
                ...
                >
                  ...
                  <input
                    ...
                    value={step.title || ""}
                    onChange={(e) =>
                      updateStepField(idx, "title", e.target.value)
                    }
                  />
                  <textarea
                    rows={2}
                    ...
                    onChange={(e) =>
                      updateStepField(idx, "description", e.target.value)
                    }
                  />
                </div>
              ))}
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label className="text-xs font-medium text-muted-foreground">
                Career Timeline (reorder & edit inline)
              </label>
              <button
                type="button"
              ...
              {(approachData.careerTimeline || []).map((item, idx) => (
                ...
                >
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      updateTimelineListField(idx, "highlights", e.target.value)
                    }
                  />
                  <textarea
                    rows={2}
                    ...
                    onChange={(e) =>
                      updateTimelineListField(idx, "tech", e.target.value)
                    }
                  />
                  <input
                    className="w-full p-2 rounded-md bg-background border border-border outline-none focus:border-primary text-sm"
