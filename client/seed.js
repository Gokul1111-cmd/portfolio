...
async function seedFirestore() {
  try {
    ...
    if (!existingProjects.empty) {
      console.log(
        "⚠️  Data already exists! Run cleanup-duplicates.js first if you want to re-seed.",
      );
      console.log(
        "💡 To force re-seed, delete all collections in Firebase Console first.",
      );
      process.exit(0);
    }
    ...
    const projects = [
      ...
      },
      {
        ...
        description:
          "Real-time weather forecasting application with location-based weather data and forecasts using OpenWeather API.",
      ...
      },
      {
        ...
        description:
          "Comprehensive restaurant booking system with table reservation, food ordering, and room booking features.",
      ...
      },
      {
        ...
        category: "Food Tech",
        description:
          "Restaurant discovery and food ordering platform inspired by Zomato with modern UI/UX.",
      ...
      },
      {
        ...
        description:
          "Recipe discovery platform featuring North and South Indian cuisines with detailed categorization.",
      ...
      },
      {
        ...
        description:
          "Smart parking management system with entry/exit tracking, billing, and payment integration.",
      ...
      },
      {
        ...
        category: "Web Design",
        description:
          "Modern parallax scrolling website showcasing automotive design with smooth animations.",
      ...
      },
      {
        ...
        description:
          "Frontend Kanban board application built with React for intuitive task management and workflow organization.",
    ...
    const aboutData = {
      ...
      experience:
        "Fresh graduate with hands-on experience building 8+ projects using modern technologies. I specialize in full-stack development, AI integration, and creating scalable web applications.",
      education: "Bachelor of Engineering in Computer Science & Engineering",
      personalSummary:
        "I believe technology should be built with purpose. My approach focuses on writing clean, scalable code and continuously learning new technologies.",
    };
    ...
    const testimonials = [
      {
        ...
        content:
          "Working with Gokul was seamless. Not only did they deliver a full-stack solution ahead of schedule, but they also communicated clearly throughout.",
        rating: 5,
      ...
      },
      {
        ...
        content:
          "I've reviewed hundreds of portfolios, and his work is truly exceptional. The way animations guide attention while maintaining performance is masterful.",
        rating: 5,
      ...
      },
      {
        ...
        content:
          "From wireframes to deployment, Gokul owned the entire stack with confidence and creativity. The final product is fast, reliable, and looks incredible.",
        rating: 5,
