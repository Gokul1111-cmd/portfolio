...
const entries = [
  ...
  },
  {
    ...
    type: 'project',
    description:
      'Build a production-ready REST API with authentication, rate limiting, input validation, error handling, and comprehensive API documentation.',
    techStack: ['Python', 'FastAPI', 'PostgreSQL', 'JWT', 'OpenAPI'],
    isPublic: true,
    order: 19,
    links: [],
    artifacts: [],
  },
  {
    ...
    type: 'project',
    description:
      'Develop a command-line tool in Go for infrastructure operations, with proper error handling, flag parsing, and concurrent operations.',
    techStack: ['Go', 'CLI', 'Cobra', 'Concurrency'],
    isPublic: true,
    order: 20,
    links: [],
    artifacts: [],
  ...
  {
    id: 'entry-automation-script-project',
    phaseId: 'foundations',
    journeyId: 'cloud-devops-security-roadmap',
    title: 'CI/CD Automation Script',
    domain: 'Python',
    status: 'Planned',
    type: 'project',
    description:
      'Create automated scripts for CI/CD tasks, build orchestration, deployment verification, and environment provisioning.',
    techStack: ['Python', 'Bash', 'CI/CD', 'Automation'],
    isPublic: true,
    order: 21,
    links: [],
    artifacts: [],
  ...
  {
    id: 'entry-git-workflow-project',
    phaseId: 'foundations',
    journeyId: 'cloud-devops-security-roadmap',
    title: 'Multi-Branch Git Workflow',
    domain: 'Git',
    status: 'Planned',
    type: 'project',
    description:
      'Design and implement Git branching strategies including feature branches, release branches, hotfixes, and automated CI/CD integration.',
    techStack: ['Git', 'GitHub', 'CI/CD', 'Branching Strategy'],
    isPublic: true,
    order: 22,
    links: [],
    artifacts: [],
  ...
  {
    id: 'entry-release-rollback-project',
    phaseId: 'foundations',
    journeyId: 'cloud-devops-security-roadmap',
    ...
    type: 'project',
    description:
      'Implement automated release tagging, version management, and rollback procedures for safe production deployments.',
    techStack: ['Git', 'GitHub Actions', 'Semantic Versioning', 'Release Automation'],
    isPublic: true,
    order: 23,
    links: [],
    artifacts: [],
  ...
  {
    id: 'entry-linux-monitoring-project',
    phaseId: 'foundations',
    journeyId: 'cloud-devops-security-roadmap',
    title: 'Linux System Health Monitoring',
    domain: 'Linux Administration',
    status: 'Planned',
    type: 'project',
    description:
      'Build comprehensive system monitoring for Linux infrastructure tracking CPU, memory, disk, network, and alerting on anomalies.',
    techStack: ['Linux', 'Prometheus', 'Grafana', 'Node Exporter', 'Monitoring'],
    isPublic: true,
    order: 24,
    links: [],
    artifacts: [],
  ...
  {
    id: 'entry-log-rotation-project',
    phaseId: 'foundations',
    journeyId: 'cloud-devops-security-roadmap',
    title: 'Log Rotation & Backup Automation',
    domain: 'Linux Administration',
    status: 'Planned',
    type: 'project',
    description:
      'Implement centralized log management with rotation, compression, archival, and backup strategies for compliance and troubleshooting.',
    techStack: ['Logrotate', 'rsyslog', 'Elasticsearch', 'Backup', 'Linux'],
    isPublic: true,
    order: 25,
    links: [],
    artifacts: [],
  ...
  {
    id: 'entry-network-troubleshooting-toolkit',
    phaseId: 'foundations',
    journeyId: 'cloud-devops-security-roadmap',
    ...
    type: 'project',
    description:
      'Create a comprehensive toolkit for network diagnostics combining tcpdump, wireshark, nmap, mtr, and traffic analysis for production troubleshooting.',
    techStack: ['tcpdump', 'Wireshark', 'nmap', 'mtr', 'Troubleshooting'],
    isPublic: true,
    order: 26,
    links: [],
    artifacts: [],
  ...
  {
    id: 'entry-cisco-networking-cert',
    phaseId: 'foundations',
    journeyId: 'cloud-devops-security-roadmap',
    ...
    status: 'Planned',
    type: 'certification',
    description: 'Cisco certification covering networking fundamentals, routing, switching, and network security.',
    techStack: ['Networking', 'Cisco', 'CCNA'],
    isPublic: true,
    order: 27,
  ...
  {
    id: 'entry-aws-cloud-practitioner',
    phaseId: 'cloud',
    journeyId: 'cloud-devops-security-roadmap',
    ...
    type: 'certification',
    description:
      'Entry-level AWS certification validating cloud knowledge and basic AWS service understanding.',
    techStack: ['AWS'],
    isPublic: true,
    order: 8,
    links: [{ label: 'AWS Certification', url: 'https://aws.amazon.com/certification/' }],
  ...
  },
  {
    ...
    phaseId: 'cloud',
    journeyId: 'cloud-devops-security-roadmap',
    title: 'EC2 Auto-Scaling Application',
    domain: 'AWS Fundamentals',
    status: 'Planned',
    type: 'project',
    description:
      'Design and deploy an auto-scaling application on AWS EC2 with load balancing, scaling policies, health checks, and monitoring.',
    techStack: ['AWS', 'EC2', 'ALB', 'Auto Scaling', 'CloudWatch'],
    isPublic: true,
    order: 9,
    links: [],
    artifacts: [],
  ...
  {
    id: 'entry-terraform-security-scanning',
    phaseId: 'iac',
    journeyId: 'cloud-devops-security-roadmap',
    title: 'Terraform Security Scanning Lab',
    domain: 'Terraform',
    status: 'Planned',
    type: 'lab',
    description:
      'Implement automated security scanning for Terraform configurations using Checkov and Terrascan to detect misconfigurations and compliance violations.',
    techStack: ['Terraform', 'Checkov', 'Terrascan', 'Security Scanning'],
    isPublic: true,
    order: 10,
    links: [],
    artifacts: [],
  ...
  {
    id: 'entry-github-actions-cert',
    phaseId: 'devops',
    journeyId: 'cloud-devops-security-roadmap',
    title: 'GitHub Actions Advanced Certification',
    domain: 'CI/CD',
    status: 'Planned',
    type: 'certification',
    description:
      'Advanced GitHub Actions certification covering workflow automation, matrix builds, secrets management, and deployment strategies.',
  ...
  },
  {
    ...
    type: 'certification',
    description:
      'Jenkins certification covering pipeline development, plugin management, and distributed build systems.',
    techStack: ['Jenkins', 'CI/CD', 'Pipeline'],
    isPublic: true,
    order: 13,
  ...
  },
  {
    ...
    type: 'certification',
    description:
      'Docker certification validating containerization expertise including image creation, orchestration, and security.',
    techStack: ['Docker', 'Containers', 'Docker Swarm'],
    isPublic: true,
    order: 14,
  ...
  },
  {
    ...
    type: 'project',
    description:
      'Develop production-grade Helm charts with templates, values management, dependencies, and Helm repository setup.',
    techStack: ['Helm', 'Kubernetes', 'YAML', 'Package Management'],
    isPublic: true,
    order: 15,
    links: [],
    artifacts: [],
  ...
  {
    id: 'entry-k8s-app-deployment-project',
    phaseId: 'devops',
    journeyId: 'cloud-devops-security-roadmap',
    ...
    type: 'project',
    description:
      'Deploy multi-tier application to Kubernetes with persistent storage, networking, and service discovery.',
    techStack: ['Kubernetes', 'Helm', 'Manifests', 'Deployment'],
    isPublic: true,
    order: 16,
    links: [],
    artifacts: [],
  ...
  {
    id: 'entry-cluster-failure-recovery-lab',
    phaseId: 'devops',
    journeyId: 'cloud-devops-security-roadmap',
    title: 'Cluster Failure Recovery Lab',
    domain: 'Kubernetes',
    status: 'Planned',
    type: 'lab',
    description:
      'Hands-on lab simulating cluster node failures, etcd corruption, and master component failures with recovery procedures.',
    techStack: ['Kubernetes', 'etcd', 'kubeadm', 'Troubleshooting', 'Cluster Recovery'],
    isPublic: true,
    order: 17,
    links: [],
    artifacts: [],
  ...
  {
    id: 'entry-zero-trust-architecture',
    phaseId: 'security',
    journeyId: 'cloud-devops-security-roadmap',
    ...
    type: 'exercise',
    description:
      'Implement Zero Trust architecture principles with mTLS for service-to-service communication, OIDC for identity verification, and micro-segmentation for network isolation.',
    techStack: ['Zero Trust', 'mTLS', 'OIDC', 'Micro-segmentation', 'Kubernetes', 'Istio'],
    isPublic: true,
    order: 11,
    links: [],
    artifacts: [],
  ...
  {
    id: 'entry-sonarqube-sast-exercise',
    phaseId: 'security',
    journeyId: 'cloud-devops-security-roadmap',
    title: 'SonarQube SAST Integration',
    domain: 'DevSecOps',
    status: 'Planned',
    type: 'exercise',
    description:
      'Integrate SonarQube for Static Application Security Testing (SAST) into CI/CD pipelines with quality gates and reporting.',
    techStack: ['SonarQube', 'SAST', 'Code Quality', 'CI/CD', 'Security'],
    isPublic: true,
    order: 13,
    links: [],
    artifacts: [],
  ...
  {
    id: 'entry-snyk-integration-exercise',
    phaseId: 'security',
    journeyId: 'cloud-devops-security-roadmap',
    title: 'Snyk Dependency Security',
    domain: 'DevSecOps',
    status: 'Planned',
    type: 'exercise',
    description:
      'Implement Snyk for dependency vulnerability scanning and automated patch recommendations across applications.',
    techStack: ['Snyk', 'Dependency Scanning', 'Vulnerability Management', 'CI/CD'],
    isPublic: true,
    order: 14,
    links: [],
    artifacts: [],
  ...
  {
    id: 'entry-comptia-security-plus',
    phaseId: 'security',
    journeyId: 'cloud-devops-security-roadmap',
    ...
    type: 'certification',
    description:
      'Industry-leading security certification covering cryptography, authentication, access control, and security operations.',
    techStack: ['Security', 'Cryptography', 'IAM'],
    isPublic: true,
    order: 15,
  ...
  },
  {
    ...
    phaseId: 'security',
    journeyId: 'cloud-devops-security-roadmap',
    title: 'Container Compromise Forensics Lab',
    domain: 'Container Security',
    status: 'Planned',
    type: 'lab',
    description:
      'Forensic analysis of compromised containers including evidence collection, log analysis, and incident reconstruction.',
    techStack: ['Docker', 'Forensics', 'Container Security', 'Incident Response'],
    isPublic: true,
    order: 16,
    links: [],
    artifacts: [],
  ...
  {
    id: 'entry-chaos-engineering-gameday',
    phaseId: 'sre',
    journeyId: 'cloud-devops-security-roadmap',
    title: 'Chaos Engineering Game Day Lab',
    domain: 'Chaos Engineering',
    status: 'Planned',
    type: 'lab',
    description:
      'Hands-on game day exercise simulating chaos engineering scenarios using LitmusChaos to test system resilience and team response capabilities.',
    techStack: ['LitmusChaos', 'Kubernetes', 'Chaos Engineering', 'Resilience Testing'],
    isPublic: true,
    order: 12,
    links: [],
    artifacts: [],
  ...
  {
    id: 'entry-alerting-strategy',
    phaseId: 'sre',
    journeyId: 'cloud-devops-security-roadmap',
    title: 'Alerting Strategy & Noise Reduction',
    domain: 'Observability',
    status: 'Planned',
    type: 'exercise',
    description:
      'Design and implement effective alerting strategies to reduce noise, false positives, and alert fatigue while ensuring critical issues are captured and escalated appropriately.',
    techStack: ['Prometheus', 'Alertmanager', 'Grafana', 'Alert Tuning', 'Observability'],
    isPublic: true,
    order: 13,
    links: [],
    artifacts: [],
  ...
  {
    id: 'entry-red-use-golden-signals',
    phaseId: 'sre',
    journeyId: 'cloud-devops-security-roadmap',
    title: 'RED/USE/Golden Signals Exercise',
    domain: 'Observability',
    status: 'Planned',
    type: 'exercise',
    description:
      'Learn and apply RED (Request rate, Errors, Duration), USE (Utilization, Saturation, Errors), and Golden Signals metrics for effective monitoring.',
    techStack: ['Prometheus', 'Grafana', 'Monitoring', 'Metrics', 'Observability'],
    isPublic: true,
    order: 17,
    links: [],
    artifacts: [],
  ...
  {
    id: 'entry-postmortem-project',
    phaseId: 'sre',
    journeyId: 'cloud-devops-security-roadmap',
    title: 'Production Incident Postmortem Project',
    domain: 'Incident Response',
    status: 'Planned',
    type: 'project',
    description:
      'Conduct comprehensive postmortem analysis on simulated production incidents including root cause analysis, action items, and prevention strategies.',
    techStack: ['Incident Response', 'Documentation', 'Analysis', 'Prevention'],
    isPublic: true,
    order: 18,
    links: [],
    artifacts: [],
  ...
  {
    id: 'entry-financial-modeling-project',
    phaseId: 'sre',
    journeyId: 'cloud-devops-security-roadmap',
    title: 'Cloud Financial Modeling Project',
    domain: 'FinOps',
    status: 'Planned',
    type: 'project',
    description:
      'Build financial models for cloud cost forecasting, budgeting, and optimization across multiple AWS accounts and services.',
    techStack: ['AWS Cost Explorer', 'Kubecost', 'FinOps', 'Financial Analysis'],
    isPublic: true,
    order: 19,
    links: [],
    artifacts: [],
  ...
  {
    id: 'entry-cost-optimization-strategies',
    phaseId: 'sre',
    journeyId: 'cloud-devops-security-roadmap',
    title: 'Cost Optimization Strategies Lab',
    domain: 'FinOps',
    status: 'Planned',
    type: 'lab',
    description:
      'Hands-on lab implementing cloud cost optimization strategies including reserved instances, spot instances, and rightSizing.',
    techStack: ['AWS', 'Cost Optimization', 'FinOps', 'Kubecost'],
    isPublic: true,
    order: 20,
    links: [],
    artifacts: [],
  ...
  {
    id: 'entry-technical-communication-project',
    phaseId: 'documentation',
    journeyId: 'cloud-devops-security-roadmap',
    ...
    type: 'project',
    description:
      'Create technical blogs, whitepapers, and case studies communicating complex engineering concepts to diverse audiences.',
    techStack: ['Technical Writing', 'Markdown', 'Documentation', 'Communication'],
    isPublic: true,
    order: 11,
    links: [],
    artifacts: [],
  ...
  {
    id: 'entry-architecture-diagrams-project',
    phaseId: 'documentation',
    journeyId: 'cloud-devops-security-roadmap',
    title: 'Architecture Diagrams & Visuals',
    domain: 'System Documentation',
    status: 'Planned',
    type: 'project',
    description:
      'Create comprehensive architecture diagrams, data flow diagrams, and visual representations using tools like Mermaid and Lucidchart.',
    techStack: ['Mermaid', 'Lucidchart', 'Visio', 'Documentation'],
    isPublic: true,
    order: 12,
    links: [],
    artifacts: [],
